...
class CustomCron extends PureComponent {
    constructor(props) {
        super(props);
        const date = new Date();
        this.state = {
    ...
    triggerChange() {
        ...
        try {
            ...
            tempArr.push("暂无最新执行week period");
        }
        if (tempArr.length > 0) {
            this.setState({
                runTime: tempArr
        ...
        return (
            <div className="cron-editor-react">
                        ...
                        <List bordered style={{ marginTop: 10 }} >
                            <List.Item className="cron-list-type">
                                <Row type="flex" gutter={5} style={{ width: "100%", textAlign: "center" }}>
                                    <Col span={3}> second </Col>
                                    <Col span={3}>minute</Col>
                                    <Col span={3}> hour</Col>
                                    <Col span={3}>day</Col>
                                    <Col span={3}>month</Col>
                                    <Col span={3}>Week</Col>
                                    <Col span={3}>year</Col>
                                </Row>
                            </List.Item>
...

                {
                    ...
                    && (
                        <Collapse>
                            <Panel header="近5次执行 hour 间" key="1">
                                <List
                                    bordered
                                    dataSource={runTime}
                                    renderItem={(item, index) => (
                                        <List.Item>
                                            First{index + 1}执行 hour 间： {item}
                                        </List.Item>
                                    )}
                                />
                            </Panel>
