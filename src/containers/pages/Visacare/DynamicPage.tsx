...
import DynamicDataJSON from '../../../assets/data/DynamicFormFieldData.json'
...
const  DynamicPage: React.FC<IDynamicPage> = ({
  ...
  return  (
    <div className="p-col-12" style={{background:'white',padding:'25px 16px 16px 16px'}} >
        {spinner &&
