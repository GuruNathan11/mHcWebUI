...
import ArrowLeft from './../../../assets/images/mettler_images/FaArrowLeft.svg';
...
import { DialogTitle, DialogContent, DialogContentText, DialogActions, FormControl, FormHelperText, InputLabel, MenuItem, Select, TextField } from "@mui/material";
...
import { createQ15CONFIG, getidptstaffQ15CONFIG } from "../../../store/actions/Q15ConfigController";
...
const PatientInfo: React.FC<IPatientInfo> = ({
  match, dispatch, createq15configData
  ...
  var patientIdData = JSON.parse(window.localStorage.getItem("LOGINDATA"));
    ...
    let decodeFinalPatientid =  patientIdData.items.data.userType[0] === "Patient"  ? patientIdData.items.data.userDetail.id : CryptoJS.AES.decrypt(decodePatientid.toString(), 'secret key 123').toString(CryptoJS.enc.Utf8);
  ...
  let [profileOpenDialog,setProfileOpenDialog] = useState(false);
  let [openDialog,setOpenDialog] = useState(false);
  let [changeStatusDialog,setChangeStatusDialog] = useState(false);
  let [addOpenDialog,setAddOpenDialog] = useState(false);
  ...
  if (!isPageLoaded && !createq15configData.isLoading) {
...
return (
    <>
      <div style={{ background: '#F2F4F9', opacity: '1', position: "relative", height: "1518px" }}>
        <div style={{ background: '#1F489F', height: '133px', display: 'flex', width: 'calc(100% - 0px)', position: 'absolute', marginTop: '-50px' }} >
          <div id="mettlerEmptyPadding" className="p-col-12 p-md-1">
            <img style={{ width: '24px', height: '24px', position: 'relative', left: '30px', top: '41px' }} src={ArrowLeft}></img>
          </div>
          <div style={{ cursor: "pointer" }} id="mettlerEmptyPadding" className="p-col-12 p-md-1">

            <img
              onClick={toggleVisibility}
              style={{ cursor: 'pointer', width: '82px', height: '82px', position: 'relative', left: '-33px', top: '10px', zIndex: 1 }}
              src={AvatarBigImage} />
          </div>
          <div id="mettlerEmptyPadding" style={{ display: 'flex', flexDirection: 'column' }} className="p-col-12 p-md-6">
            <div style={{ display: 'flex' }}>
              <div style={{ position: 'relative', top: '31px', left: '-37px', minWidth: 'max-content' }} className="App-TopBar-PatientName">{inputPatientInfo}</div>
              <div style={{ position: 'relative', top: '38px', left: '-28px', minWidth: 'max-content' }} className="App-TopBar-PatientAge">{patientAge} Years</div>
            </div>
            <div style={{ display: 'flex', position: 'relative', left: '200px', top: '-30px' }}>
              <div style={{ position: 'relative', top: '70px', left: '-237px' }} className="App-TopBar-PatientCheck">
                <img style={{ width: '34px', height: '34px', position: 'relative', top: '8px', left: '5px' }} src={bloodBag}></img>
                <span style={{ opacity: 0.6000000238418579, position: 'relative', left: '7px' }} className="App-TopBar-BloodName">Blood</span>
                <span style={{ position: 'relative', top: '18px', left: '-26px', fontSize: '14px' }} className="App-TopBar-PatientValue">A</span><span style={{ position: 'relative', top: '17px', left: '-26px' }} className="App-TopBar-PatientValue">+</span>
              </div>
              <div style={{ position: 'relative', top: '70px', left: '-226px' }} className="App-TopBar-PatientCheck">
                <img style={{ width: '33px', height: '33px', position: 'relative', top: '10px', left: '5px' }} src={bloodDrop}></img>
                <span style={{ opacity: 0.6000000238418579, position: 'relative', left: '6px', top: '4px', fontSize: '14px' }} className="App-TopBar-BloodName">Height</span>
                <span style={{ position: 'relative', top: '19px', left: '-39px', fontSize: '14px' }} className="App-TopBar-PatientValue">A</span><span style={{ position: 'relative', top: '19px', left: '-39px', fontSize: '14px' }} className="App-TopBar-PatientValue">+</span>
              </div>
              <div style={{ position: 'relative', top: '70px', left: '-215px' }} className="App-TopBar-PatientCheck">
                <img style={{ width: '36px', height: '36px', position: 'relative', top: '10px', left: '5px' }} src={bloodDropNew}></img>
                <span style={{ opacity: 0.6000000238418579, position: 'relative', left: '42px', top: '-28px', fontSize: '14px' }} className="App-TopBar-BloodName">Weight</span>
                <span style={{ position: 'relative', top: '-10px', left: '-7px', fontSize: '14px' }} className="App-TopBar-PatientValue">45kg</span>
              </div>
              <div style={{ position: 'relative', top: '70px', left: '-204px' }} className="App-TopBar-PatientCheck">
                <img style={{ width: '36px', height: '36px', position: 'relative', top: '10px', left: '5px' }} src={bloodDropNewOne}></img>
                <span style={{ opacity: 0.6000000238418579, position: 'relative', left: '7px', top: '2px', fontSize: '14px' }} className="App-TopBar-BloodName">DOB</span>
                <span style={{ position: 'relative', top: '-7px', left: '38px', fontSize: '11px', display: 'flex' }} className="App-TopBar-PatientValue">{patientDateOfBirth}</span>
              </div>
              <div style={{ position: 'relative', top: '70px', left: '-195px' }} className="App-TopBar-DoctorDetails">
                <div style={{ width: '32px', height: '32px', position: 'relative', top: '10.5px', left: '15px' }} className="App-TopBar-AboutDoctorImage"></div>
                <span style={{ fontSize: '18px', position: 'relative', top: '-16.5px', left: '55px' }} className="App-TopBar-PatientValue">Dr. Linda Blair, OP</span>
              </div>
            </div>
          </div>
          <div id="mettlerEmptyPadding" className="p-col-12 p-md-2">  </div>
          <div id="mettlerEmptyPadding" style={{ textAlign: 'center', marginLeft: '-39px', marginTop: '22px' }} className="p-col-12 p-md-2">
            <img style={{ width: '17px', height: '20px', position: 'relative', marginTop: '18px', left: '-19px' }} src={notificationImage}></img>
            <span style={{ display: 'inline-block', position: 'relative', left: '-30px', top: '2px' }} className="notificationCount">2</span>
            <img style={{ width: '27px', height: '27px', position: 'relative', marginTop: '18px', left: '1px' }} src={mailImage}></img>
            <span style={{ display: 'inline-block', position: 'relative', left: '-8px', top: '3px' }} className="notificationCount">2</span>
            <a style={{ cursor: 'pointer' }} onClick={backToLogin}><img style={{ width: '24px', height: '24px', position: 'relative', marginTop: '18px', left: '11px' }} src={settingsImage}></img></a>
            <a style={{ cursor: 'pointer' }} onClick={handleProfileDialog}><img style={{ width: '32px', height: '32px', position: 'relative', marginTop: '13px', top: '3px', borderRadius: '32px', left: '43px' }} src={Avatar}></img></a>
            <a style={{ cursor: 'pointer' }} onClick={backToLogin}><img style={{ width: '9px', height: '5.52px', position: 'relative', marginTop: '16.5px', borderRadius: '32px', left: '48px' }} src={downArrowImage}></img></a>
          </div>
        </div>
...
<DialogContentText >
  <div style={{display:'flex',flexDirection:'column',position:'relative',left:'18px',top:'18px'}}>
    ...
    <a style={{cursor:'pointer'}} onClick={()=>{setChangeStatusDialog(true)}}><div style={{position:'relative',top:'30px',fontSize:'14px'}} className="AppTopBar-profileName">Change Status</div></a>
...
<Dialog maxWidth={'md'} PaperProps={{sx: {overflow:'hidden',height:'180px',width:'200px',position:'absolute',top:'6px',right:'-2px'} }}  
        ...
        onClose={()=>{setProfileOpenDialog(false)}}
      >
<DialogContentText >
  <div style={{display:'flex',flexDirection:'column'}}>
    <div style={{display:'flex',flexDirection:'row',width: "200px",height: '49px',flexShrink: 0,background:'#F2F4F8'}}>     
      ...
      <div style={{position:'relative',left:'25px',top:'5px',width:'141px'}} className="AppTopBar-profileName">{inputPatientInfo}</div>      
      <div style={{position:'relative',left:'-115px',top:'25px',color:'#232434',fontWeight:300}} className="AppTopBar-profileName">{patientAge}</div>      
    </div>  
    ...
    <div style={{display:'flex',flexDirection:'row',position:'relative',left:'17px',top:'30px'}}>
    ...
    <a style={{cursor:'pointer'}} onClick={handleLogOut}><div style={{display:'flex',flexDirection:'row',position:'relative',left:'17px',top:'40px'}}>
  ...
  <div style={{position:'relative',left:'75px',top:'125px',fontSize:'14px'}} className="AppTopBar-profileName">
      ...
      <div className="cancel-group">
        <SecondaryButton
          ...
          onCancelContainerClick={()=>{setChangeStatusDialog(false)}}
        />
        ...
        <PrimaryButton
          ...
          onNextContainerClick={()=>{setAddOpenDialog(true)}}
        />
      </div>
      </div>
      </>
...
<Dialog maxWidth={'md'} PaperProps={{sx: {overflow:'hidden',height:'330px',width:'450px',position:'absolute',top:'6px'} }}  
        open={addOpenDialog}
        onClose={()=>{setAddOpenDialog(false)}}
      >
<DialogContentText >
  <>
  <div style={{display:'flex',position:'relative',left:'30px',top:'22px'}}>
  ...
  <div style={{position:'relative',top:'72px',left:'32px'}}>
    <FormControl className="secondary-name-input77" variant="outlined">
                                          ...
                                          <Select color="primary" size="medium" label="Status" style={{width:'210px',height:'36px'}}>
      ...
      <div className="cancel-group">
        <SecondaryButton
          label="No"
          secondaryButtonCursor="pointer"
          onCancelContainerClick={()=>setAddOpenDialog(false)}
        />
        <div className="previous1">
          <img className="bg-icon3" alt="" src={bottomImage} />
          <div className="label5">Previous</div>
        ...
        <PrimaryButton
          label="Yes"
          primaryButtonCursor="pointer"
          onNextContainerClick={()=>setAddOpenDialog(false)}
        />
      </div>
      </div>
      </>
        ...
        <div style={{ borderRadius: "14px", backgroundColor: "#FAFCFF", position: "relative", top: "83px", width: "330px", height: "1159px", display: "flex" }}>
          <div style={{}}>
            ...
            <div style={{ display: "flex", flexDirection: "column", backgroundColor: "#EFF4FF", position: "absolute", top: "131px", left: "26px", width: "270px", height: "52px", borderRadius: "6px" }}>
              <div>
                <span style={{ fontWeight: "bolder", color: "#000000", fontSize: "35px", position: "absolute", top: "-7px", left: "7px" }}>.</span>
                <span style={{ position: "absolute", top: "15px", left: "38px", fontSize: "17px", color: "#3F3F46" }}>Overview</span>
              </div>
              <div>
                <span style={{ fontWeight: "bolder", color: "#000000", fontSize: "35px", position: "absolute", top: "50px", left: "7px" }}>.</span>
                <span style={{ top: "72px", position: "absolute", left: "40px", fontSize: "16px" }}>Q-15 Form</span>
              </div>
              <div>
                <span style={{ fontWeight: "bolder", color: "#000000", fontSize: "35px", position: "absolute", top: "101px", left: "7px" }}>.</span>
                <span style={{ top: "124px", position: "absolute", left: "40px", fontSize: "16px" }}>Admit Patient</span>
              </div>
              <div>
                                <a style={{ cursor: "pointer" }} onClick={toggleVisibilitys}> <span style={{ top: "172px", position: "absolute", left: "40px", fontSize: "16px", zIndex: 1 }} >Patient Data/Orders</span>
                            ...
                            {isVisibled && (
                                <>
                                    <div>
                                        <a style={{ cursor: 'pointer' }} ><img style={{ fontWeight: "bolder", color: "#000000", fontSize: "35px", position: "absolute", top: "225px", left: "51px" }} src={Groupss}></img>
                                            <span style={{ top: "222px", position: "absolute", left: "74px", fontSize: "16px" }} >Patient Data</span></a>
                                    </div>
                                    <div>
                                        <a style={{ cursor: 'pointer' }} > <img style={{ fontWeight: "bolder", color: "#000000", fontSize: "35px", position: "absolute", top: "277px", left: "51px" }} src={Groupss}></img>
                            ...
                            <div style={{ position: isVisibled ? 'relative' : 'relative', top: isVisibled ? "" : "-143px" }}>
                                <a style={{ cursor: "pointer" }} onClick={toggleVisibilityss}><span style={{ top: "371px", position: "absolute", transform: isVisibleds ? "rotate(90deg)" : "rotate(360deg)" }}><i className="large material-icons">chevron_right</i></span>
                                    <span style={{ top: "371px", position: "absolute", left: "41px", fontSize: "16px" }}>Treatment Plan</span></a>

                            </div>
                            {isVisibleds && (
                                <>
                                    < div style={{ position: "absolute", top: isVisibled ? "139px" : "" }}>
                                        <div style={{ position: "absolute", left: "20px", top: "160px" }}>
                                            <input type="text" className="dashboard-search-text" id="new" name="new" placeholder="Search" style={{ paddingLeft: '36px', top: "106px", fontFamily: 'system-ui', position: 'relative', width: '165px', left: '17px' }} />
                                            <img src={searchImage} style={{ width: '20px', height: '20px', position: 'relative', left: '24px', top: '82px', opacity: 0.3 }}></img>
                                        </div>
                                        <div style={{ position: "absolute", top: "311px", left: '36px', backgroundColor: "#EFF4FF", width: "217px", height: "52px", borderRadius: "6px" }}>
                            ...
                            <div style={{ position: 'absolute', top: isVisibled ? '364px' : '222px' }}>
                                <span style={{ top: isVisibleds ? "235px" : "57px", position: "absolute" }}><i className="large material-icons">chevron_right</i></span>
                                <span style={{ top: isVisibleds ? "235px" : "57px", position: "absolute", left: "41px", fontSize: "16px" }}>Reports</span>
                            </div>
            </div>
        ...
        <div style={{ position: "relative", left: "322px" , top: "-1169px" , width: "fit-content" }}>
          <div id="mettlerEmptyPadding" style={{ display: 'flex' }}>
            <div style={{ position: 'absolute', left: '18px' , top:  '103px' , width: "193.974px", height:  "123.763px" }} className="Patient-EHR-HeartRate">
              ...
              <div style={{ position: 'relative', left: '20.67px', top: '-15px', fontSize:  "19px" }} className="Patient-EHR-RateValue">110 bpm<img style={{ width: '85.455px', height: '78.421px', position: 'relative', top: '12.23px', left: "9.67px"  }} src={beatShadowImage}></img></div>
            ...
            <div style={{ position: 'absolute', left: '229px' , top:  '102px' , width: "193.974px", height:  "123.763px" }} className="Patient-EHR-Temperature">
              ...
              <div style={{ position: 'relative', left: '20.67px', top: '-15px', fontSize:  "19px" }} className="Patient-EHR-RateValue">99.4 °C<img style={{ width: '85.455px', height: '78.421px', position: 'relative', top: '12.23px', left:  "21.67px"  }} src={TemperaturImage}></img></div>
              <img style={{ width: '18.207px', height: '10.207px', position: 'relative', top: '-42.39px', left: '20.67px' }} src={arrowUpRight}></img>
              <div style={{ position: 'relative', left: '48.67px', top: '-62.23px', fontSize: '14px' }} className="Patient_EHR-HeartRateName">1.6 °C</div>
            </div>
            <div style={{ position: 'absolute', left:  '439px' , top:  '102px' , width:  "193.974px" , height:  "123.763px"  }} className="Patient-EHR-HeartRate">
              ...
              <div style={{ position: 'relative', left: '20.67px', top: '-15px', fontSize:  "19px"  }} className="Patient-EHR-RateValue">120/99<img style={{ width: '85.455px', height: '78.421px', position: 'relative', top: '12.23px', left: "21.67px"  }} src={BpImage}></img></div>
              <img style={{ width: '16px', height: '16px', position: 'relative', top: '-42.39px', left: '20.67px' }} src={GrLikeImage}></img>
              <div style={{ position: 'relative', left: '48.67px', top: '-62.23px', fontSize: '14px' }} className="Patient_EHR-HeartRateName">22 bpm</div>
            </div>
            <div style={{ position: 'absolute', left:  '648px' , top:  '102px' , width: "193.974px" , height:  "123.763px"}} className="Patient-EHR-HeartRate">
              ...
              <div style={{ position: 'relative', left: '20.67px', top: '-15px', fontSize: "19px"  }} className="Patient-EHR-RateValue">50 mg/dl<img style={{ width: '85.455px', height: '78.421px', position: 'relative', top: '12.23px', left:  "9.67px"  }} src={GlucoseImage}></img></div>
          ...
          <div id="mettlerEmptyPadding" style={{ display: 'flex', width: "fit-content" }}>
            <div style={{ width: '278px', height: '241px', background: '#FFF', position: 'relative', left: '18px', top: '246px', borderRadius: '10px' }}>
            ...
            <div style={{ width: '278px', height: '241px', background: '#FFF', position: 'relative', left: '30px', top: '246px', borderRadius: '10px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <a style={{ cursor: 'pointer' }} onClick={handleQ15Change}  ><div style={{ position: 'relative', left: '41px', top: '248px', borderRadius: '10px', width: "252px", height: "64px" }} className="patient-Q15-Width">
          ...
          <div id="mettlerEmptyPadding" style={{ display: 'flex', width: "fit-content" }}>
            <div style={{ width: '160px', height: '279px', background: '#FFF', position: 'relative', left: '18px', top: '536px', borderRadius: '10px' }}>
            ...
            <div style={{ width: '567px', height: '261px', background: '#FFF', position: 'relative', left: '-143px', top: '261px', borderRadius: '10px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <div style={{ width: '88px', height: '24px', background: 'rgba(255, 175, 1, 0.36)', position: 'relative', left: '334px', top: '34px', borderRadius: '60px' }}>
              ...
              <div style={{ width: '514px', height: '1px', color: '#A5A8C3', position: 'relative', left: '28px', top: '43px', borderBottomStyle: 'dashed' }}></div>
              <div style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <div style={{ width: '88px', height: '24px', background: 'rgba(255, 175, 1, 0.36)', position: 'relative', left: '273px', top: '55px', borderRadius: '60px' }}>
                  <div style={{ position: 'relative', left: '12px', fontSize: '14px', color: '#FF6B00', opacity: 0.6 }} className="Patient-datatable-name">Pending</div>
                </div>
              </div>
              <div style={{ width: '514px', height: '1px', color: '#A5A8C3', position: 'relative', left: '28px', top: '64px', borderBottomStyle: 'dashed' }}></div>
              <div style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <div style={{ width: '88px', height: '24px', background: 'rgba(255, 175, 1, 0.36)', position: 'relative', left: '236px', top: '76px', borderRadius: '60px' }}>
                  <div style={{ position: 'relative', left: '12px', fontSize: '14px', color: '#FF6B00', opacity: 0.6 }} className="Patient-datatable-name">Pending</div>
                </div>
              </div>
              <div style={{ width: '514px', height: '1px', color: '#A5A8C3', position: 'relative', left: '28px', top: '85px', borderBottomStyle: 'dashed' }}></div>
              <div style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <div style={{ width: '88px', height: '24px', background: 'rgba(255, 175, 1, 0.36)', position: 'relative', left: '236px', top: '97px', borderRadius: '60px' }}>
                  <div style={{ position: 'relative', left: '12px', fontSize: '14px', color: '#FF6B00', opacity: 0.6 }} className="Patient-datatable-name">Pending</div>
                </div>
              </div>
            </div>
            <div style={{ width: '253px', height: '498px', background: '#FFF', position: 'relative', left: '-129px', top: '82px', borderRadius: '10px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'row' }}>
                <a style={{ cursor: 'pointer' }} onClick={() => handleCalendarScheduleChange(1)}><div style={{ position: 'relative', left: '14px', top: '49px', width: "50px", height: "64px" }} className={calendarScheduleChange === 1 ? "patient-Q15-CalendarSelectOutline" : "patient-Q15-CalendarUnselectOutline"}>
                  <div style={{ position: 'relative', left: '2px', top: '49px', width: "44px" }} className={calendarScheduleChange === 1 ? "patient-Q15-CalendarSelectLine" : "patient-Q15-CalendarUnSelectLine"}>
                    <div style={{ position: 'relative', left: "10px", top: "-41px" }} className="patient-Q15-CalendarText">{calendarDate.getDate() - 3}</div>
                ...
                <a style={{ cursor: 'pointer' }} onClick={() => handleCalendarScheduleChange(2)}><div style={{ position: 'relative', left: "23px", top: '49px', width: "50px", height: "64px" }} className={calendarScheduleChange === 2 ? "patient-Q15-CalendarSelectOutline" : "patient-Q15-CalendarUnselectOutline"}>
                  <div style={{ position: 'relative', left: '1.5px', top: '49px', width: "44px" }} className={calendarScheduleChange === 2 ? "patient-Q15-CalendarSelectLine" : "patient-Q15-CalendarUnSelectLine"}>
                    <div style={{ position: 'relative', left: "10px", top: "-41px" }} className="patient-Q15-CalendarText">{calendarDate.getDate() - 2}</div>
                ...
                <a style={{ cursor: 'pointer' }} onClick={() => handleCalendarScheduleChange(3)}><div style={{ position: 'relative', left: "33px", top: '49px', width: "50px", height: "64px" }} className={calendarScheduleChange === 3 ? "patient-Q15-CalendarSelectOutline" : "patient-Q15-CalendarUnselectOutline"}>
                  <div style={{ position: 'relative', left: '1.5px', top: '49px', width: "44px" }} className={calendarScheduleChange === 3 ? "patient-Q15-CalendarSelectLine" : "patient-Q15-CalendarUnSelectLine"}>
                    <div style={{ position: 'relative', left: "10px", top: "-41px" }} className="patient-Q15-CalendarText">{calendarDate.getDate() - 1}</div>
                ...
                <a style={{ cursor: 'pointer' }} onClick={() => handleCalendarScheduleChange(4)}><div style={{ position: 'relative', left: "43px", top: '49px', width: "50px", height: "64px" }} className={calendarScheduleChange === 4 ? "patient-Q15-CalendarSelectOutline" : "patient-Q15-CalendarUnselectOutline"}>
                  <div style={{ position: 'relative', left: '1.5px', top: '49px', width: "44px" }} className={calendarScheduleChange === 4 ? "patient-Q15-CalendarSelectLine" : "patient-Q15-CalendarUnSelectLine"}>
                    <div style={{ position: 'relative', left: "10px", top: "-41px" }} className="patient-Q15-CalendarText">{calendarDate.getDate()}</div>
                    <div style={{ position: 'relative', left: '12px', top: '-36px', fontSize: '12px' }} className="patient-Q15-CalendarText">{forthDay}</div>
                  </div>
                </div></a>
              </div>
              {/* className="patient-schedule-yogaWidth" */}
              <div style={{ width: '199px', height: '1px', color: '#A5A8C3', position: 'relative', left: '28px', top: '139px', borderBottomStyle: 'dashed' }}></div>
              ...
              <div style={{ width: '199px', height: '1px', color: '#A5A8C3', position: 'relative', left: '28px', top: '152px', borderBottomStyle: 'dashed' }}></div>
              ...
              <div style={{ width: '199px', height: '1px', color: '#A5A8C3', position: 'relative', left: '28px', top: '167px', borderBottomStyle: 'dashed' }}></div>
              ...
              <div style={{ width: '199px', height: '1px', color: '#A5A8C3', position: 'relative', left: '28px', top: '183px', borderBottomStyle: 'dashed' }}></div>
          ...
          <div id="mettlerEmptyPadding" style={{ display: 'flex', width: "fit-content" }}>
            <div style={{ width: '399px', height: '279px', background: '#FFF', position: 'relative', left: '189px', top: '37px', borderRadius: '10px' }}>
            ...
            <div style={{ width: '249px', height: '276px', background: '#FFF', position: 'relative', left: '199px', top: '93px', borderRadius: '10px' }}>
              <div style={{ color: '#081529', position: 'relative', left: '51px', top: '21px' }} className="patient-Q15-text">Daily Progress</div>
              <div style={{ display: 'flex', flexDirection: 'column' }} >
                <img style={{ width: '124px', height: '124px', position: 'relative', top: '38px', left: '67px' }} src={dailyProgressImage}></img>
                <img style={{ width: '124px', height: '124px', position: 'relative', top: '-86.5px', left: '67px' }} src={dailyProgressAdjustImage}></img>
                <div style={{ position: 'relative', left: '8px', top: '-153px' }} className="patient-dailyProgress-Text">78%</div>
                <div style={{ position: 'relative', left: '3px', top: '-96px', color: '#081529', fontSize: '12px', opacity: 0.4, textAlignLast: 'center' }} className="patient-Q15-text">Keep improving the <br />quality of your health</div>
              </div>
            </div>
          </div>
        </div>

        <Dialog maxWidth={'md'} PaperProps={{ sx: { width: '450px', position: 'absolute', height: '600px' } }} style={{ left: '826px', top: '-48px', height: '700px' }}
...
const mapStateToProps = (state: any) => {
  const { deviceFormData, createq15configData } = state;
  return {
    deviceFormData, createq15configData
  };
};
